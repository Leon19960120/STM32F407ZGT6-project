...
/***************----- 端口的运行模式 -----***************/
extern uint8_t S0_Mode;					// 端口0的运行模式, 0:TCP服务器, 1:TCP客户端, 2:UDP
#define TCP_SERVER		0x00			// TCP服务器模式
#define TCP_CLIENT		0x01			// TCP客户端模式 
#define UDP_MODE		0x02			// UDP(广播)模式 

/***************----- 端口的运行状态 -----***************/
extern uint8_t S0_State;				// 端口0状态记录, 1:完成初始化, 2:完成连接(可正常传输) 
#define S_INIT			0x01			// 端口完成初始化 
#define S_CONN			0x02			// 端口完成连接,可以正常传输数据 

/***************----- 端口收发数据的状态 -----***************/
extern uint8_t S0_Data;					// 端口0接收和发送数据的状态, 1:接收到数据, 2:发送完成 
...
/***************----- 自定义数据类型 -----***************/
typedef uint8_t SOCKET;					// 自定义端口号数据类型 (W5500的Socket编号为0~7)
...
extern void W5500_Hareware_Reset(void);
